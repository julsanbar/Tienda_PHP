        ...
        <?php if(!isset($_SESSION['usuario'])): ?>
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3 p-5">
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        ...
                        <button type="submit" class="btn btn-primary" name="enviar">Iniciar</button>
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3 pb-3">
                    ...
                    <a href="controllers/controller.registrar.php" class="offset-md-5 btn btn-success btn-lg" role="button">¡Crear!</a>
        ...
        <?php else: ?>
            <div class="row">
                <div class="col-md-6 offset-md-3 p-5">
                    ...
                    <a class="btn btn-outline-danger" href="controllers/controller.listado.php" role="button">Volver a la lista de productos</a>
